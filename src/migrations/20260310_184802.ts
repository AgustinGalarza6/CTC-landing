...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`categories_subcategories\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`categories_subcategories_order_idx\` ON \`categories_subcategories\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`categories_subcategories_parent_id_idx\` ON \`categories_subcategories\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`services_services_features\` (
  	\`_order\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`services_services_features_order_idx\` ON \`services_services_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`services_services_features_parent_id_idx\` ON \`services_services_features\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`services_services\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`icon\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`services_services_order_idx\` ON \`services_services\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`services_services_parent_id_idx\` ON \`services_services\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE TABLE \`why_choose_us_points\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`icon\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`why_choose_us_points_order_idx\` ON \`why_choose_us_points\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`why_choose_us_points_parent_id_idx\` ON \`why_choose_us_points\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`why_choose_us\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE TABLE \`testimonials_testimonials\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`testimonials_testimonials_order_idx\` ON \`testimonials_testimonials\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`testimonials_testimonials_parent_id_idx\` ON \`testimonials_testimonials\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`testimonials_testimonials_avatar_idx\` ON \`testimonials_testimonials\` (\`avatar_id\`);`)
  ...
  `)
  await db.run(sql`CREATE TABLE \`faqs_faqs\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`faqs_faqs_order_idx\` ON \`faqs_faqs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`faqs_faqs_parent_id_idx\` ON \`faqs_faqs\` (\`_parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE TABLE \`cta_section\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`categories_subcategories\`;`)
  ...
  await db.run(sql`DROP TABLE \`services_services_features\`;`)
  await db.run(sql`DROP TABLE \`services_services\`;`)
  await db.run(sql`DROP TABLE \`services\`;`)
  await db.run(sql`DROP TABLE \`why_choose_us_points\`;`)
  await db.run(sql`DROP TABLE \`why_choose_us\`;`)
  await db.run(sql`DROP TABLE \`testimonials_testimonials\`;`)
  await db.run(sql`DROP TABLE \`testimonials\`;`)
  await db.run(sql`DROP TABLE \`faqs_faqs\`;`)
  await db.run(sql`DROP TABLE \`faqs\`;`)
  await db.run(sql`DROP TABLE \`cta_section\`;`)
