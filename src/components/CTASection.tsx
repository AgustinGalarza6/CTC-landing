      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-normal mb-6 text-white">
            ¿Necesita soluciones tecnológicas para optimizar su empresa?
          </h2>
          <p className="text-lg md:text-xl text-white mb-10 max-w-3xl mx-auto font-normal">
            Consulte con nuestro equipo para encontrar la solución tecnológica ideal.
          </p>
          ...
          {/* Trust badges */}
          <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-white font-normal">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Soluciones adaptadas a cada operación</span>
            </div>
          </div>
        </div>
      </div>
